...
public abstract class Character implements Comparable {
    ...
    public String toFile() {
        ...
        return this.name+";"+this.type+";"+this.gold+";"+this.lives+";"+this.time+";"+this.win;
    }
    ...
    public boolean equals(Object o) {
        ...
        return lives == character.lives && gold == character.gold && time == character.time && win == character.win;
    }

    @Override
    public int hashCode() {
        return Objects.hash(lives, gold, time, win);
    }
    ...
    public int compareTo(Object o) {
        ...
        if (o instanceof Character) {
            ...
            if (this.win && (((Character) o).win) || !this.win && !(((Character) o).win)) {

                value = ((Character) o).gold - this.gold;

                if (value == 0) {

                    value = ((Character) o).time - this.time;


                    if (value == 0) {

                        value = ((Character) o).lives - this.lives;

                    }
                }
                return value;

            } else if (this.win && !(((Character) o).win)) {
                value = -1;
                return value;
